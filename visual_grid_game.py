...
class VisualGridHuntGame:
    ...
    """
    Grid environment containing:
    - walls
    - food
    - toxic traps
    - opponents
    - SearchAgent percept information
    """
    ...
    def __init__(
        ...
        while (
            ...
            if (
                ...
                and
                opponent_tuple
                not in self.toxic_traps
                and
                opponent_position
                not in self.opponents
            ):
    ...
    def get_percept(self):
        ...
        return {
            ...
            # =================================================
            # PRACTICAL 05
            # LOGICAL FACTS ASSOCIATED WITH SPECIFIC TILES
            # =================================================
            #
            ...
            # -> Retreat
            #
            # Therefore A* should reject this tile.
            #
            # =================================================
...
class GridGameGUI:
    ...
    def __init__(
        ...
        self.root.title(
            "IT3012 - A* Search with Knowledge Base"
        )
